        ...
        <div>
            ...
            <section className="text-center mb-20 w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4  mx-auto">
                    {[
                        { src: '/images/logos/chatgpt.png', alt: 'ChatGPT 4' },
                        { src: '/images/logos/deepseek.png', alt: 'Whale' },
                        { src: '/images/logos/grmini.png', alt: 'Gemini' },
                        { src: '/images/logos/pixelcut.png', alt: 'Pixelcut' },
                        { src: '/images/logos/cam.png', alt: 'Film' },
                        { src: '/images/logos/perplexity.png', alt: 'Porphlexity' },
                    ].map(({ src, alt }) => (
                        <div
                            key={alt}
                            className="bg-black rounded-lg flex flex-col items-center text-center relative overflow-hidden min-h-[360px] max-h-[500px]"
                        >
                            {/* Image Wrapper */}
