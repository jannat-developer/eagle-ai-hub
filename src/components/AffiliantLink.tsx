...
const AffiliantLink = () => {
    return (
        <div className='bg-black'>
            ...
            <h1 className='text-[2.2rem] font-semibold text-center'>Your Affiliate Link</h1>
            <p className='text-[0.95rem] text-[#888888] font-regular text-center'>Share link to earn commission</p>
